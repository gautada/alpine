...
- Scripts - Maybe use `set -xe` for debugging. See: [The Set Built-in](https://www.gnu.org/software/bash/manual/bash.html#The-Set-Builtin). I think this might only be for bash
